...
layout = [
    ...
    [
        sg.Text('选择翻译模板语言', background_color="#e3f2fd", text_color='#212121'),
...
def startocr(obj):
    ...
    cmd = "{pybin}  -i {sourcedir} -o {targetdir}  -f {imgformat} --translator={lang} --detector {detector} {heibai}".format(pybin=pybin,  sourcedir=obj['sourcedir'], targetdir=obj['targetdir'], lang=obj['lang'], imgformat=obj['imgformat'], detector=obj['detector'], heibai=obj['heibai'])
    if obj['usegpu']:
        cmd += " --use-cuda"
